...
if(mysqli_num_rows($resultado)>0){
    ...
    while ($productos=mysqli_fetch_assoc($resultado)) {
        echo "
            <div class='card' style='width: 25rem; margin: 20px; display: inline-block; vertical-align: top;'> <a href='detalle.php?id_producto=".$productos['id']."' style='text-decoration: none; color: black;'>
