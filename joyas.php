  ...
  <div class="row justify-content-center">
    ...
    <div class="col-md-4 mb-4">
      <div class="card" style="width: 25rem;">
        <img src="im/anillo.jpg" class="card-img-top" alt="">
        <div class="card-body">
    ...
    <!-- CARD 2 -->
      <div class="col-md-4 mb-4">
        <div class="card" style="width: 25rem;">
          <img src="im/arrito6.jpg" class="card-img-top" alt="">
          <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
      <div class="card" style="width: 25rem;">
        <img src="im/arritoflor.jpg" class="card-img-top" alt="">
        <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
      <div class="card" style="width: 25rem;">
        <img src="im/collarsol.jpg" class="card-img-top" alt="">
        <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
      <div class="card" style="width: 25rem;">
        <img src="im/pulsera2.jpg" class="card-img-top" alt="">
        <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
      <div class="card" style="width: 25rem;">
        <img src="im/anillos24.jpg" class="card-img-top" alt="">
        <div class="card-body">
