...
if(mysqli_num_rows($resultado)>0){
    ...
    echo "<h1 style='text-align: center; text-transform: uppercase; text-family: Simple Dreams; text-font: 40px;'>Ofertas</h1>";
    while ($productos=mysqli_fetch_assoc($resultado)) {
        echo "
             <div class='card' style='width: 25rem; margin: 40px; display: inline-block;'>
                <img src='".$productos['imagen']."' class='card-img-top' alt='' style='height: 500px; width: 80%;'>
                <div class='card-body'>
